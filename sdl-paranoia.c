...
int page8()
{
	...
	print_text("citizen known as Retailers.  The strategy used is to imply that all good ");
	...
	print_text("control a disproportionate amount of the currency.  In this way Christmas ");
...
int page11()
{
	...
	print_text("Step 1: Compel the briefing subject to attend the briefing.\n");
	print_text("        Note: See Experimental Briefing Sub Form Indigo-WY-2,\n");
	print_text("        \'Experimental Self Briefing Subject Acquisition Through The Use Of\n");
	print_text("         Neurotoxin Room Foggers.\'\n");
	print_text("Step 2: Inform the briefing subject that the briefing has begun.\n");
	print_text("        ATTENTION: THE BRIEFING HAS BEGUN.\n");
	print_text("Step 3: Present the briefing material to the briefing subject.\n");
	print_text("        GREETINGS TROUBLESHOOTER.\n");
	print_text("        YOU HAVE BEEN SPECIALLY SELECTED TO SINGLEHANDEDLY\n");
	print_text("        WIPE OUT A DEN OF TRAITOROUS CHRISTMAS ACTIVITY.  YOUR MISSION IS TO\n");
	print_text("        GO TO GOODS DISTRIBUTION HALL 7-BETA AND ASSESS ANY CHRISTMAS ACTIVITY\n");
	print_text("        YOU FIND THERE.  YOU ARE TO INFILTRATE THESE CHRISTMAS CELEBRANTS,\n");
	print_text("        LOCATE THEIR RINGLEADER, AN UNKNOWN MASTER RETAILER, AND BRING HIM\n");
	print_text("        BACK FOR EXECUTION AND TRIAL.  THANK YOU.  THE COMPUTER IS YOUR FRIEND.\n");
	print_text("Step 4: Sign the briefing subject\'s briefing release form to indicate that\n");
	print_text("        the briefing subject has completed the briefing.\n");
	print_text("        ATTENTION: PLEASE SIGN YOUR BRIEFING RELEASE FORM.\n");
